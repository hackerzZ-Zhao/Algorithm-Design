...
int main() {
    ...
    string filename = "/Users/zhaoziwei/CLionProjects/ShorestPath/testG2.txt";
    //string filename = "/Users/zhaoziwei/CLionProjects/ShorestPath/testG_negative_circle.txt";
    int V = 5;
